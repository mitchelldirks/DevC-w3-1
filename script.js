...
var tampilan = document.getElementById("tampil");
for(var i=0;i<Starwars.results.length;i++){
console.log(Starwars.results[i].name);
};

function renderHTML(Starwars) {
    var htmlstring = "";
    htmlstring +="<table>"
        + "<tr><th>Name</th>" 
        ...
        +"<th>Gravity</th>" 
        + "<th>Climate</th></tr>";
    for (ii = 0; ii < Starwars.results.length; ii++) {
        htmlstring += "<tr> "
